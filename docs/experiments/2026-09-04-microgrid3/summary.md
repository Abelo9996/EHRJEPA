# Ablation grid -- 2026-09-04-microgrid3
...
Rows are appended by `scripts/ablate.py` as each run finishes. Last update: 2026-09-04T04:42:03+00:00.
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| `micro3_lambda_pred0` | jepa | mean@final | ema | 0.05 | 0.6 | 50 | 819,200 | 0.9639 | -- | -- | -- | -- | 142.7 | 0 | 7,337 | 59.6 | 0.6758 | 0.5762 | 0.6893 | 0.6954 | 0.7228 | 0.687 | 0.6488 |
...
| `random_init@micro3_lambda_pred0` | 0.6775 | 0.5699 | 0.6962 | 0.6961 | 0.7252 | 0.6882 | 0.6619 |
