...
Rows are appended by `scripts/ablate.py` as each run finishes. Last update: 2026-09-03T17:02:09+00:00.
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| `micro_ar` | ar | -- | -- | -- | 200 | 3,276,800 | 7.486 | -- | 7.486 | 0.09345 | 0.2064 | 89.18 | 0 | 6,711 | 236.3 | 0.6938 | 0.6135 | 0.7052 | 0.6991 | 0.7375 | 0.704 | 0.6385 |
| `micro_jepa_ema` | jepa | ema | 0.05 | 0.6 | 200 | 3,276,800 | 0.2105 | 0.2094 | -- | -- | -- | 143.7 | 0.08986 | 8,903 | 190.9 | 0.6701 | 0.6162 | 0.6918 | 0.6906 | 0.7148 | 0.6896 | 0.6267 |
...
| `random_init@micro_ar` | 0.6751 | 0.616 | 0.694 | 0.689 | 0.7211 | 0.6904 | 0.6464 |
| `random_init@micro_jepa_ema` | 0.685 | 0.6021 | 0.7005 | 0.6933 | 0.7264 | 0.7001 | 0.6675 |
